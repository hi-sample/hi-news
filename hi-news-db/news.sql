...
一路披荆斩棘、披星戴月，虽然辛苦，但却在这个过程里变得更加勇敢和坚强。', N'拉拉', N'2022-11-29 10:00:43.000', NULL)
GO
...
INSERT INTO [dbo].[news] ([id], [title], [news_content], [publisher], [gmt_create], [gmt_modify]) VALUES (N'12', N'伽利略的重力实验', N'史上最早的思想实验之一，由物理和天文学家伽利略进行实验。为了反驳亚里士多德的自由落体速度取决于物体质量的理论，伽利略设计了一个简单的思想实验：根据亚里士多德的逻辑，如果一个较轻的物体和一个较重的物体绑在一起后从塔上扔下去，那么教重的物体会下落的比较快，且两个物体间的绳子会被拉紧。这时较轻的物体会对较重的物体产生一个拽力，使得重物的下落速度变慢。但是，伽利略认为两个物体绑在一起后的重量应比其中任意一个物体都大，那么一起下落的速度应该是最快的。于是他用这个矛盾证明了亚里士多德理论是错误的。', N'123', N'2022-11-29 10:08:38.000', NULL)
GO
